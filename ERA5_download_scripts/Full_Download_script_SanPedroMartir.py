...
# add these lines to skip files that are already downloaded
...
# 2m-temperature
path = "'/home/caroline/chaldene/Astroclimate_Project/sites/SPM/Data/Era_5/T/single_levels/'"
...
with open(filename, 'w') as file:
    ...
    file.write("path = {} \n".format(path))
    file.write("area = '32/-116.5/30/-114.5' \n")
    file.write("for i in range(1979, 2021):#range(1979, 2021): \n")
    file.write("    filename_str = path + 'Era5_San_Pedro_Martir_' + str(i) + '_' + variable + '.nc' \n")
    file.write("    print(filename_str) \n")
    file.write("    Era5_single_level_retrieve(str(i), variable, area , filename_str) \n")

# total column water
path = "'/home/caroline/chaldene/Astroclimate_Project/sites/SPM/Data/Era_5/TCW/'"

filename = 'tcw.py'
with open(filename, 'w') as file:
    file.write("from cds_api_era5 import Era5_single_level_retrieve \n")
    file.write("variable = 'total_column_water' \n")
    file.write("path = {} \n".for        file.write("    if os.path.exists(filename_str) == True: \n")
        file.write("        print('file already exists') \n")
        file.write("        continue\n")mat(path))
    file.write("area = '32/-116.5/30/-114.5' \n")
    file.write("for i in range(1979, 2021):#range(1979, 2021): \n")
...
# surface_pressure
path = "'/home/caroline/chaldene/Astroclimate_Project/sites/SPM/Data/Era_5/surface_pressure/'"
...
# pressure_levels = [700, 750, 775, 800, 825, 850] #
pressure_levels = [875]

path = "'/home/caroline/chaldene/Astroclimate_Project/sites/SPM/Data/Era_5/T/pressure_levels/' +  pressure_level + 'hPa/'"
...
for P in pressure_levels:
    ...
    with open(filename, 'w') as file:
        ...
        file.write("area = '32/-116.5/30/-114.5' \n")
        file.write("for i in range(1979, 2021):#range(1979, 2021): \n")
        file.write("    filename_str = path + 'Era5_San_Pedro_Martir_' + str(i) + '_' + variable + '_'+ pressure_level + 'hPa.nc' \n")
        file.write("    print(filename_str) \n")
        file.write("    if os.path.exists(filename_str) == True: \n")
        file.write("        print('file already exists') \n")
        file.write("        continue\n")
...
pressure_levels = [875]
path = "'/home/caroline/chaldene/Astroclimate_Project/sites/SPM/Data/Era_5/RH/' +  pressure_level + 'hPa/'"
...
#path = "'/home/caroline/chaldene/Astroclimate_Project/sites/SPM/Data/Era_5/SH/' +  pressure_level + 'hPa/'"
path = "'/home/haslebacher/chaldene/Astroclimate_Project/sites/SPM/Data/Era_5/SH/' +  pressure_level + 'hPa/'"
...
#%% SH: run files
pressure_levels = [250, 300, 350, 400, 450, 500, 550, 600, 650]
for P in pressure_levels:
    filename = 'SH' + str(P) +'.py' # change filename only
    # path = "/home/caroline/chaldene/API/" + filename
    path = "/home/haslebacher/chaldene/API/" + filename
    command = "gnome-terminal -e 'bash -c \"python3 " + path + "; exec bash\"'"
    os.system(command)

# bash
# for P in 250, 300, 350, 400, 450, 500, 550, 600, 650
#     do
#         screen -S SPM_{P}
#         exit
#     exit
...
pressure_levels = [50, 100, 125, 150, 175, 200, 225, 250, 300, 350, 400, 450, 500, 550, 600, 650,  700, 750, 775, 800, 825, 850, 875, 900] 

path = "'/home/caroline/chaldene/Astroclimate_Project/sites/SPM/Data/Era_5/seeing/' +  pressure_level + 'hPa/'"
...
for P in pressure_levels:
    ...
    with open(filename, 'w') as file:
        ...
        file.write("    filename_str = path + 'Era5_San_Pedro_Martir_' + str(i) + '_seeing_params_'+ pressure_level + 'hPa.nc' \n")
...
import os 
#pressure_levels = [50, 100, 125, 150, 175, 200, 225, 250, 300, 350, 400, 450, 500, 550, 600, 650,  700, 750, 775, 800, 825, 850, 875, 900] 
pressure_levels = [50, 125, 350 ,450, 750, 850] 
...
path = "'/home/haslebacher/chaldene/Astroclimate_Project/sites/SPM/Data/Era_5/total_cloud_cover/'"
