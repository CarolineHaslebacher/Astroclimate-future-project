...
# 2m-temperature
path = "'/home/caroline/chaldene/Astroclimate_Project/sites/Sutherland/Data/Era_5/T/single_levels/'"
...
with open(filename, 'w') as file:
    ...
    file.write("path = {} \n".format(path))
    file.write("area = '-31.75/19/-33.5/22' \n")
    file.write("for i in range(1979, 2021):#range(1979, 2021): \n")
    file.write("    filename_str = path + 'Era5_Sutherland_' + str(i) + '_' + variable + '.nc' \n")
    file.write("    print(filename_str) \n")
    file.write("    Era5_single_level_retrieve(str(i), variable, area , filename_str) \n")

# total column water
path = "'/home/caroline/chaldene/Astroclimate_Project/sites/Sutherland/Data/Era_5/TCW/'"
...
# surface_pressure
path = "'/home/caroline/chaldene/Astroclimate_Project/sites/Sutherland/Data/Era_5/surface_pressure/'"
...
pressure_levels = [800,825,850,875] #
path = "'/home/caroline/chaldene/Astroclimate_Project/sites/Sutherland/Data/Era_5/T/pressure_levels/' +  pressure_level + 'hPa/'"
...
for P in pressure_levels:
    ...
    with open(filename, 'w') as file:
        ...
        file.write("area = '-31.75/19/-33.5/22' \n")
        file.write("for i in range(1979, 2021):#range(1979, 2021): \n")
        file.write("    filename_str = path + 'Era5_Sutherland_' + str(i) + '_' + variable + '_'+ pressure_level + 'hPa.nc' \n")
...
# define pressure levels, path and area
pressure_levels = [800,825,850,875] # rest is already downloaded
path = "'/home/caroline/chaldene/Astroclimate_Project/sites/Sutherland/Data/Era_5/RH/' +  pressure_level + 'hPa/'"
...
# define pressure levels, path and area
# pressure_levels = [800,825,850,875]
pressure_levels = [250, 300, 350, 400, 450, 500, 550, 600, 650, 700, 750, 775] # for tcw
 # rest is already downloaded
# path = "'/home/caroline/chaldene/Astroclimate_Project/sites/Sutherland/Data/Era_5/SH/' +  pressure_level + 'hPa/'"
path = "'/home/haslebacher/chaldene/Astroclimate_Project/sites/Sutherland/Data/Era_5/SH/' +  pressure_level + 'hPa/'"
...
path = "'/home/haslebacher/chaldene/Astroclimate_Project/sites/Sutherland/Data/Era_5/seeing/' +  pressure_level + 'hPa/'"
...
for P in pressure_levels:
    ...
    with open(filename, 'w') as file:
        ...
        file.write("area = '-31.75/19/-33.5/22' \n") # select area!
        file.write("for i in range(1979, 2021): \n") # select years!
        file.write("    filename_str = path + 'Era5_Sutherland_' + str(i) + '_seeing_params_'+ pressure_level + 'hPa.nc' \n")
        # skip files that are already downloaded
        file.write("    if os.path.exists(filename_str) == True: \n")
        file.write("        print('file already exists') \n")
        file.write("        continue\n")
...
# pressure_levels = [50, 100, 125, 150, 175, 200, 225, 250, 300, 350, 400, 450, 500, 550, 600, 650,  700, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000] 
# one half first
# pressure_levels = [50, 100, 125, 150, 175, 200, 225, 250, 300, 350, 400, 450, 500, 550]

pressure_levels = [600, 650,  700, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000]
...
# python3 /home/haslebacher/chaldene/API/seeing_800.py

#%% total cloud cover

path = "'/home/haslebacher/chaldene/Astroclimate_Project/sites/Sutherland/Data/Era_5/total_cloud_cover/'"
