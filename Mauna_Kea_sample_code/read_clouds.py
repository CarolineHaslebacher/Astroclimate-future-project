...
df_insitu = pd.read_csv('./sites/MaunaKea/Data/in-situ/gemini_weather_loss_2013-2017_north_MaunaKea.csv')
...
df_insitu['Mauna Kea Clouds'] = df_insitu['weather']/df_insitu['available']

# %%
# daily data

# extract useful data
df_extracted = df_insitu[['Mauna Kea Clouds']]
...
# %%
# save to csv
df_extracted.to_csv('./sites/MaunaKea/Data/in-situ/daily_weather_loss_MaunaKea_Gemini.csv', header = True, index = True)
