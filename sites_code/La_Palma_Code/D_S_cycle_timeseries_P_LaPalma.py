...
# open NETCDF file
ds_surf_Pr = xr.open_mfdataset('./sites/La_Palma/Data/Era_5/surface_pressure/*.nc', combine = 'by_coords')

#open in-situ measurements as pandas dataframe
P_hourly = pd.read_csv('./sites/La_Palma/Data/in-situ/hourly_meteo/hourly_La_Palma_RH_T_P.csv')

 
#%% convert netcdf to dataframe, label pressure levels
# change coords!!!!!!!!!

df_surf_Pr = netcdf_to_df(ds_surf_Pr,-17.88, 28.76)
...
# %%
os.chdir('/home/haslebacher/chaldene/Astroclimate_Project')
plot_cycle(diurnal_P,'diurnal cycle Cerro de la_Palma', 'La_Palma Pressure', 
           './sites/La_Palma/Output/Plots/P/diurnal_cycle_UTC_P_La_Palma_1997to2020.pdf', 
           'sp')
           
# ./sites/MaunaKea/Output/Plots/P/
# %%
plot_cycle(seasonal_P,'seasonal cycle Cerro de la_Palma', 'La_Palma Pressure', 
           './sites/La_Palma/Output/Plots/P/seasonal_cycle_UTC_P_La_Palma_1997to2020.pdf',
           'sp')


# %%
#plot_timeseries_merged('./sites/La_Palma/Output/Plots/P/Timeseries_UTC_P_all_1997to2019.pdf', merged_df_P, monthly_grouped_P, yearly_grouped_P, 
#'relative_humidity', '700hPa', '750hPa', '800hPa')

# %%
# plot timeseries, moving average

yearly_grouped_P = yearly_grouped_P.loc['1997-12-31':'2019-12-31']

plot_timeseries_movav('./sites/La_Palma/Output/Plots/P/timeseries_La_Palma_P_1997to2019_movav.pdf', yearly_grouped_P,
 df_merged = merged_df_P, In_situ = 'La_Palma Pressure', Era5_surface_pressure = 'sp')

# use merged_df
# plot_timeseries_long(filename, yearly_grouped_insitu ,insitu_param, yearly_grouped_era5,**kwargs
plot_timeseries_long('./sites/La_Palma/Output/Plots/P/timeseries_La_Palma_P_1997to2019_long.pdf', yearly_grouped_P,
['La_Palma Pressure'], yearly_grouped_P_era5.loc[:'2019-12-31'], moving = False, Era5_surface_pressure = 'sp')

# %%
# correlation plot: alpha = 0.05

parameter = 'sp'
insitu_param = 'La_Palma Pressure'
path = './sites/La_Palma/Output/Plots/P/correlation_P_La_Palma_' + parameter +'_1997to2020'
