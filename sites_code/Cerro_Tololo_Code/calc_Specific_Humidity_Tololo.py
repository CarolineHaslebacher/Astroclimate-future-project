...
# %%
#observational data from Cerro_Tololo; temperature, RH, pressure
os.chdir('/home/haslebacher/chaldene/Astroclimate_Project')
Cerro_Tololo_hourly = pd.read_csv('./sites/cerro_Tololo/Data/in-situ/hourly_meteo/hourly_Cerro_Tololo_T_RH_P.csv')
...
Cerro_Tololo_hourly['specific_humidity'] = np.vectorize(Specific_humidity)(Cerro_Tololo_hourly['Cerro Tololo Temperature'], Cerro_Tololo_hourly['Cerro Tololo Pressure (hPa)'], Cerro_Tololo_hourly['Cerro Tololo Relative Humidity'])
...
#%% to csv
Cerro_Tololo_hourly.to_csv('/home/haslebacher/chaldene/Astroclimate_Project/sites/Cerro_Tololo/Data/in-situ/Specific_humidity_Cerro_Tololo_2002to2019.csv')
