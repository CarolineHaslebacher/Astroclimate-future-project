...
ds_tcw = xr.open_mfdataset('./sites/Paranal/DPWV_hourlyata/Era_5/TCW/*.nc', combine = 'by_coords')
...
PWV_hourly = pd.read_csv('./sites/Paranal/Data/in-situ/hourly_meteo/hourly_instantaneous_Paranal_PWV.csv')
...
plot_cycle(diurnal_PWV,'diurnal cycle Cerro Paranal', 'PWV Paranal', 
           './sites/Paranal/Output/Plots/TCW/diurnal_cycle_UTC_TCW_instantaneous_Paranal_2015to2019.pdf', 
           'tcw')
           
# %% seasonal cycle
plot_cycle(seasonal_PWV,'seasonal cycle Cerro Paranal', 'PWV Paranal', 
           './sites/Paranal/Output/Plots/TCW/seasonal_cycle_UTC_TCW_instantaneous_Paranal_2015to2019.pdf', 
           'tcw')
...
plot_timeseries_long('./sites/Paranal/Output/Plots/TCW/timeseries_Paranal_TCW_instantaneous_2015to2019_long.pdf', yearly_grouped_PWV,
...
parameter = 'tcw'
path = './sites/Paranal/Output/Plots/TCW/correlation_Paranal_' + parameter +'_instantaneous_2015to2020_'
