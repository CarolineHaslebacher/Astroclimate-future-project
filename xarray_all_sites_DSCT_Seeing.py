...
# list_of_single_level_vars = ['wind speed seeing']
list_of_clim_vars = ['J_poly']
variable = 'seeing_pf'
# list_of_clim_vars = ['seeing']
# list_of_model_clim_params = ['seeing']

# load
path_seeing = './sites/'+ site_name_folder + '/Data/Era_5/seeing_pf/ds_ERA5_seeing_monthly_polyfit_integral.nc'
ds_seeing = xr.open_dataset(path_seeing).load()
climxa.epsilon(ds_seeing['J_poly'])
# irgendwie chunnt das chli scheisse use!

plt.plot( d_obs['ds_taylor'].time, d_obs['ds_taylor']['Seeing SPM'])
plt.plot()
...
# ds_sel shows different values!model_color_PRIMAVERA_label
# plot?
